...
DROP PROCEDURE IF EXISTS LISTAR_POLITICA;p
...
BEGIN
	INSERT INTO MAQUINARIA (NOMBRE, TIPO,ACTIVO) VALUES (_NOMBRE, _TIPO,_ACTIVO);
...
BEGIN
	SELECT T.DNI AS DNI ,T.NOMBRE AS NOMBRE,R.DESCRIPCION AS DESCRIPCION FROM TRABAJADOR T INNER JOIN ROL R WHERE  NOMBRES LIKE CONCAT('%', _NOMBRES,'%') AND T.FK_ID_ROL = R.ID_ROL;
END$
...
BEGIN
	INSERT INTO INSUMO (NOMBRE,GRANULARIDAD,COLOR,CANTIDAD,UNIDAD,RESTRICCION) VALUES (_NOMBRE, _GRANULARIDAD ,_COLOR,
	_CANTIDAD,_UNIDAD,_RESTRICCION);
...
BEGIN
	INSERT INTO PRODUCTO (NOMBRE, GRANULARIDAD, PRESENTACION,FK_ID_INSTRUCTIVO, RESTRICCION)
	VALUES (_NOMBRE,_GRANULARIDAD,_PRESENTACION,_FK_ID_INSTRUCTIVO,_RESTRICCION);
...
BEGIN
	SELECT NOMBRE,PRESENTACION,GRANULARIDAD,RESTRICCION FROM PRODUCTO WHERE NOMBRE LIKE CONCAT('%', _NOMBRE,'%');
END$
